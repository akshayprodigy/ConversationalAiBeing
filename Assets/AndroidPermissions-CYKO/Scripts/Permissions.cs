...
public class Permissions : MonoBehaviour
{
	...
	public Text msg;
    public LoadNextInIntro LoadNextInIntro;
	...
	public void AllowAll()
	{
...

        {
			...
			//contacts.sprite = done;
			All.sprite = done;
            LoadNextInIntro.OnLoadNextScene();
	...
	public void PermissionTypeButton(string type)
	{
		...
		else if (permissionType == "all") { msg.text = "Please allow All Permissions: Camera,  Microphone and Storage"; }//Phone State, Location, Contacts
