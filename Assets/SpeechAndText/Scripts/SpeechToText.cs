...
namespace TextSpeech
{
    public class SpeechToText : MonoBehaviour
    {
       ...
       // public Action<string> onResultCallback;
        public delegate void ResultCallback(string msg);
        public static event ResultCallback onResultCallback;
        ...
        {
            //Debug.Log("zee onResults: " + _results);
            Debug.Log("zee onResults: onResultCallback" + onResultCallback+ " _results "+ _results);
